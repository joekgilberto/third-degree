...
export default function CategoryIndex() {
  ...
  return (
    <div className='CategoryIndex'>
      <Banner source='https://images.unsplash.com/photo-1544383835-bda2bc66a55d?q=80&w=1436&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' altText='brown wooden drawer' sub='Smart your engines!' link='https://unsplash.com/@jankolar' credit='Jan Antonin Kolar' />
      <div className='pick'>
